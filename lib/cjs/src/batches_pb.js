...
protobuf_1.proto3.util.setEnumType(BATCH_SORT_KEY, "scanswift.BATCH_SORT_KEY", [
...
BatchesServiceCreateRequest.typeName = "scanswift.BatchesServiceCreateRequest";
...
Batch.typeName = "scanswift.Batch";
Batch.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 12, name: "quantity", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 13, name: "internal_code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 20, name: "is_downloaded", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 21, name: "download_count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
]);
/**
 *
...
BatchesList.typeName = "scanswift.BatchesList";
...
BatchesServicePaginationReq.typeName = "scanswift.BatchesServicePaginationReq";
...
BatchPaginationResp.typeName = "scanswift.BatchPaginationResp";
...
BatchesServiceFilterReq.typeName = "scanswift.BatchesServiceFilterReq";
...
BatchesServiceSearchAllReq.typeName = "scanswift.BatchesServiceSearchAllReq";
...
BatchesServiceCommissioningRequest.typeName = "scanswift.BatchesServiceCommissioningRequest";
...
BatchIdentifierWithSerialState.typeName = "scanswift.BatchIdentifierWithSerialState";
