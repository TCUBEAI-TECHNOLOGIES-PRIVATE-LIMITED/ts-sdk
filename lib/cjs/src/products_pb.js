...
protobuf_1.proto3.util.setEnumType(PRINT_CODE_TYPE, "scanswift.PRINT_CODE_TYPE", [
...
(function (PRINT_ENCODING_TYPE_FOR_PRODUCT) {
     ...
     */
    PRINT_ENCODING_TYPE_FOR_PRODUCT[PRINT_ENCODING_TYPE_FOR_PRODUCT["PRINT_ENCODING_TYPE_FOR_PRODUCT_URI_SHORT"] = 2] = "PRINT_ENCODING_TYPE_FOR_PRODUCT_URI_SHORT";
...
protobuf_1.proto3.util.setEnumType(PRINT_ENCODING_TYPE_FOR_PRODUCT, "scanswift.PRINT_ENCODING_TYPE_FOR_PRODUCT", [
...
protobuf_1.proto3.util.setEnumType(PRODUCT_SORT_KEY, "scanswift.PRODUCT_SORT_KEY", [
...
class ProductsServiceCreateRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.shelfLifeDays = protobuf_1.protoInt64.zero;
        /**
         ...
         */
        this.printEncodingType = PRINT_ENCODING_TYPE_FOR_PRODUCT.PRINT_ENCODING_TYPE_FOR_PRODUCT_HRI_UNSPECIFIED;
        /**
         * THe type of code that needs to be printed
         *
         * @generated from field: scanswift.PRINT_CODE_TYPE print_code_type = 30;
         */
        this.printCodeType = PRINT_CODE_TYPE.QR_UNSPECIFIED;
        /**
...
ProductsServiceCreateRequest.typeName = "scanswift.ProductsServiceCreateRequest";
ProductsServiceCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 31, name: "template_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
/**
 *
...
ProductsServiceUpdateRequest.typeName = "scanswift.ProductsServiceUpdateRequest";
...
Product.typeName = "scanswift.Product";
...
ProductsList.typeName = "scanswift.ProductsList";
...
class ProductsServicePaginationReq extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.sortKey = PRODUCT_SORT_KEY.PRODUCT_SORT_KEY_ID_UNSPECIFIED;
        /**
         * UUID of the entity
         *
...
ProductsServicePaginationReq.typeName = "scanswift.ProductsServicePaginationReq";
...
ProductPaginationResp.runtime = protobuf_1.proto3;
ProductPaginationResp.typeName = "scanswift.ProductPaginationResp";
ProductPaginationResp.fields = protobuf_1.proto3.util.newFieldList(() => [
...
ProductsServiceFilterReq.typeName = "scanswift.ProductsServiceFilterReq";
...
ProductsServiceSearchAllReq.typeName = "scanswift.ProductsServiceSearchAllReq";
