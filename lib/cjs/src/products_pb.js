...
(function (PRINT_PAPER_SIZE) {
     ...
     */
    PRINT_PAPER_SIZE[PRINT_PAPER_SIZE["WIDTH_80MM"] = 1] = "WIDTH_80MM";
    /**
     * Print the batch on a 58mm wide thermal printer
     *
     * @generated from enum value: WIDTH_58MM = 2;
     */
    PRINT_PAPER_SIZE[PRINT_PAPER_SIZE["WIDTH_58MM"] = 2] = "WIDTH_58MM";
...
class ProductsServiceCreateRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.printBatchPaperSize = PRINT_PAPER_SIZE.A4_UNSPECIFIED;
...
ProductsServiceCreateRequest.typeName = "tcube.ProductsServiceCreateRequest";
...
ProductsServiceUpdateRequest.typeName = "tcube.ProductsServiceUpdateRequest";
...
Product.typeName = "tcube.Product";
...
ProductsList.typeName = "tcube.ProductsList";
...
ProductsServicePaginationReq.typeName = "tcube.ProductsServicePaginationReq";
...
ProductPaginationResp.typeName = "tcube.ProductPaginationResp";
...
ProductsServiceFilterReq.typeName = "tcube.ProductsServiceFilterReq";
...
ProductsServiceSearchAllReq.typeName = "tcube.ProductsServiceSearchAllReq";
