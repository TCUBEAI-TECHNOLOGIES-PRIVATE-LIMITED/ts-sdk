...
protobuf_1.proto3.util.setEnumType(SERIAL_STATE, "scanswift.SERIAL_STATE", [
...
protobuf_1.proto3.util.setEnumType(SERIAL_ACTIVITY, "scanswift.SERIAL_ACTIVITY", [
...
protobuf_1.proto3.util.setEnumType(SERIAL_SORT_KEY, "scanswift.SERIAL_SORT_KEY", [
...
SerialsServiceRegisterActivityRequest.typeName = "scanswift.SerialsServiceRegisterActivityRequest";
...
SerialsServiceCommissionBulkRequest.typeName = "scanswift.SerialsServiceCommissionBulkRequest";
...
SerialsServiceSerialCodes.typeName = "scanswift.SerialsServiceSerialCodes";
...
SerialsServiceCreateRequest.typeName = "scanswift.SerialsServiceCreateRequest";
...
class Serial extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.commissionedAt = protobuf_1.protoInt64.zero;
        /**
...
Serial.typeName = "scanswift.Serial";
 ...
 */
class SerialMetadata extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         ...
         */
        this.expiryTimestamp = protobuf_1.protoInt64.zero;
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(SerialMetadata, a, b);
    }
}
exports.SerialMetadata = SerialMetadata;
SerialMetadata.runtime = protobuf_1.proto3;
SerialMetadata.typeName = "scanswift.SerialMetadata";
SerialMetadata.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 10, name: "product", kind: "message", T: products_pb_js_1.Product },
...
SerialsList.typeName = "scanswift.SerialsList";
...
SerialActivity.typeName = "scanswift.SerialActivity";
...
SerialActivitiesList.typeName = "scanswift.SerialActivitiesList";
...
ViewSerialActivitiesRequest.typeName = "scanswift.ViewSerialActivitiesRequest";
...
SerialsServicePaginationReq.typeName = "scanswift.SerialsServicePaginationReq";
...
SerialPaginationResp.typeName = "scanswift.SerialPaginationResp";
...
SerialsServiceFilterReq.typeName = "scanswift.SerialsServiceFilterReq";
...
SerialsServiceSearchAllReq.typeName = "scanswift.SerialsServiceSearchAllReq";
...
SerialsServiceAnalyticsGroupByStateRequest.typeName = "scanswift.SerialsServiceAnalyticsGroupByStateRequest";
...
SerialsServiceStateAndCountMessageList.typeName = "scanswift.SerialsServiceStateAndCountMessageList";
...
SerialsServiceStateAndCountMessage.typeName = "scanswift.SerialsServiceStateAndCountMessage";
