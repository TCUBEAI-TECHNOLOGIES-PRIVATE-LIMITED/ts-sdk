...
class BatchesServiceCreateRequest extends protobuf_1.Message {
    ...
    static typeName = "scanswift.BatchesServiceCreateRequest";
...
class Batch extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.Batch";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class BatchesList extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchesList";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class BatchesServicePaginationReq extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchesServicePaginationReq";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class BatchPaginationResp extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchPaginationResp";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class BatchesServiceFilterReq extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchesServiceFilterReq";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
        { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
        { no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
...
class BatchesServiceSearchAllReq extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchesServiceSearchAllReq";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
        { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
        { no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
...
class BatchesServiceCommissioningRequest extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchesServiceCommissioningRequest";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
class BatchIdentifierWithSerialState extends protobuf_1.Message {
     ...
     */
    serialState = serials_pb_js_1.SERIAL_STATE.SERIAL_STATE_ANY_UNSPECIFIED;
    constructor(data) {
        super();
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static runtime = protobuf_1.proto3;
    static typeName = "scanswift.BatchIdentifierWithSerialState";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
