...
proto3.util.setEnumType(SORT_ORDER, "scanswift.SORT_ORDER", [
...
proto3.util.setEnumType(DEVICE_TYPE, "scanswift.DEVICE_TYPE", [
...
proto3.util.setEnumType(LOGBOOK_OPERATION, "scanswift.LOGBOOK_OPERATION", [
...
proto3.util.setEnumType(DOWNLOADED_STATUS, "scanswift.DOWNLOADED_STATUS", [
 ...
 */
export class FileResponseList extends Message<FileResponseList> {
  /**
   * List of files
   *
  ...
  static equals(a: FileResponseList | PlainMessage<FileResponseList> | undefined, b: FileResponseList | PlainMessage<FileResponseList> | undefined): boolean {
    return proto3.util.equals(FileResponseList, a, b);
  }
}
