...
proto3.util.setEnumType(PACKAGING_STATE, "scanswift.PACKAGING_STATE", [
...
proto3.util.setEnumType(PRINT_ENCODING_TYPE_FOR_PACKAGING, "scanswift.PRINT_ENCODING_TYPE_FOR_PACKAGING", [
...
proto3.util.setEnumType(PACKAGING_SORT_KEY, "scanswift.PACKAGING_SORT_KEY", [
 ...
 */
export class PackagingMetadata extends Message<PackagingMetadata> {
  /**
  ...
  static equals(a: PackagingMetadata | PlainMessage<PackagingMetadata> | undefined, b: PackagingMetadata | PlainMessage<PackagingMetadata> | undefined): boolean {
    return proto3.util.equals(PackagingMetadata, a, b);
  }
}
